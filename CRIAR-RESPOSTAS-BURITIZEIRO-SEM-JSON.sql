-- CRIAR-RESPOSTAS-BURITIZEIRO-SEM-JSON.sql
-- Versão sem a coluna fonte_json
...
begin
  ...
  if v_exist is null then
    ...
    set observacao = coalesce(p_observacao, r.observacao),
