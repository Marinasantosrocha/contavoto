    ...
    <div className="app-container">
            ...
            <div className="card">
              <div className="card-header">
                ...
                <p className="card-subtitle">
                  {tipoUsuario === 5 && 'Super Administrador - Acesso total ao sistema'}
                  {tipoUsuario === 4 && 'Administrador - Gerenciamento completo'}
                  {tipoUsuario === 3 && 'Suporte Técnico - Acesso limitado'}
                  {tipoUsuario === 2 && 'Candidato - Visualização de dados'}
                </p>
              </div>
      ...
      <nav className="bottom-nav">
        <div className="bottom-nav-content">
          ...
          <div className="nav-item" onClick={onVerPesquisas}>
            <div className="nav-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="nav-item" onClick={handleGoToPermissions}>
            <div className="nav-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="nav-item" onClick={handleGoToSettings}>
            <div className="nav-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
